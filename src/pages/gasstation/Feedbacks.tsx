...
const Feedbacks = () => {
  ...
  const totalRatings = ratingDistribution.reduce((acc, item) => acc + item.users, 0);
  const weightedSum = ratingDistribution.reduce((acc, item) => acc + item.stars * item.users, 0);
    ...
    <div>
      <div className="flex items-center mb-6">
        <div className="flex-1">
          ...
          <h1 className="text-xl font-semibold text-fuelGreen-500 inline-block">Feedbacks</h1>
          <p className="text-gray-500 ml-8">Rating and feedback of your station</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            {ratingDistribution.map((item) => (
              <div key={item.stars} className="flex items-center">
                ...
                <div className="text-sm text-gray-500 w-20 text-right">{item.users} Users</div>
              </div>
            ))}
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            {feedbacksData.map((feedback) => (
              <div key={feedback.id} className="border-l-4 border-fuelGreen-500 pl-4 py-1">
          ...
          <div className="flex items-center justify-center mt-6 gap-1">
            <Button variant="outline" size="icon" className="h-8 w-8 rounded-full" disabled={page === 1}>
