      ...
      <div className="w-full md:w-1/2 bg-white p-8 flex items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="usernameEmail" className="block text-sm font-medium text-gray-700 mb-1">Username / Email *</label>
              <input
                type="text"
                id="usernameEmail"
                name="usernameEmail"
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="#" className="text-sm text-fuelGreen-500 hover:underline">
                Forgot password?
              </a>
            </div>
